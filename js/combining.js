...
!(function(e, t) {
    ...
    function Fe(e, t, n) {
        ...
        return (
            (n = n || $e(e)) &&
            ("" !== (a = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e) || (a = w.style(e, t)), !h.pixelBoxStyles() && We.test(a) && Be.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o))),
            void 0 !== a ? a + "" : a
        );
    }
            ...
            ajax: function(t, n) {
                ...
                (f = w.event && h.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
                    ...
                    ((d = h.url.slice(o.length)),
                        h.data && (h.processData || "string" == typeof h.data) && ((o += (kt.test(o) ? "&" : "?") + h.data), delete h.data), !1 === h.cache && ((o = o.replace(Ht, "$1")), (d = (kt.test(o) ? "&" : "?") + "_=" + Et++ + d)),
                        (h.url = o + d)),
                            ...
                            return function() {
                                n &&
                                    ((n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null),
                                        ...
                                        o(Vt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                            binary: s.response
                                        } : {
                                            text: s.responseText
                ...
                (t.show = function() {
                    ...
                    if (!this._isTransitioning &&
                        ...
                        (this._parent &&
                            ...
                            (t = null), !(t && (e = g(t).not(this._selector).data(ht)) && e._isTransitioning))
                    ) {
        ...
        (e.prototype = {
            ...
            checkDisabled: function() {
                ...
                this.isDisabled() ?
                    ...
                    (this.$button.hasClass("disabled") && (this.$newElement.removeClass("disabled"), this.$button.removeClass("disabled")), -1 != this.$button.attr("tabindex") || this.$element.data("tabindex") || this.$button.removeAttr("tabindex")),
    ...
    !(function() {
        ...
        (b.prototype.addHtml = function(b) {
            ...
            if (
                (this.s.dynamic ?
                    ...
                    ((d = this.$items.eq(b)),
                        d.attr("data-sub-html-url") ? (c = d.attr("data-sub-html-url")) : ((e = d.attr("data-sub-html")), this.s.getCaptionFromTitleOrAlt && !e && (e = d.attr("title") || d.find("img").first().attr("alt")))), !c)
            )
                if (void 0 !== e && null !== e) {
        ...
        (b.prototype.loadContent = function(b, c, d) {
            ...
            k.$slide
                ...
                o && o.html5 && !l && k.$slide.eq(b).addClass("lg-complete"), !0 === c &&
        ...
        var b = {
            ...
            c = function(c) {
                return (
                    ...
                    (this.$el = a(c)), !(this.core.$items.length < 2) &&
        ...
        (c.prototype.build = function() {
            ...
            d.core.$outer.find(".lg-thumb").html(e),
                ...
                c.each(function() {
                    ...
                    c &&
                        a.getJSON("//www.vimeo.com/api/v2/video/" + c + ".json?callback=?", {
                            format: "json"
                        }, function(a) {
        ...
        (c.prototype.animateThumb = function(a) {
            ...
            if (this.core.s.animateThumb) {
                ...
                this.left > this.thumbTotalWidth - this.thumbOuterWidth && (this.left = this.thumbTotalWidth - this.thumbOuterWidth),
                    ...
                    (b.hasClass("on") || this.core.$outer.find(".lg-thumb").css("transition-duration", this.core.s.speed + "ms"), this.core.doCss() || b.animate({
                        left: -this.left + "px"
                    }, this.core.s.speed)) :
    ...
    return {
        ...
        load: function() {
            jQuery("select").length && jQuery("select").selectpicker(),
                ...
                jQuery("body").append(
                    '<a href="https://wa.me/+91-9821024186" target="_blank" class="bt-buy-now theme-btn"><i class="fa fa-whatsapp" aria-hidden="true"></i><span>Whatsapp</span></a><a href="tel:+91-7703900062" target="_blank" class="bt-support-now theme-btn"><i class="ti-headphone-alt"></i><span>Call Now</span></a>\x3c!-- Go to www.addthis.com/dashboard to customize your tools --\x3e<script type="text/javascript" src="../../s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"></script>'
                );
        },
        resize: function() {
            (e = $(window).width()),
